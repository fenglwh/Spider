...
class Spider():
    ...
    def load_driver(self, type="phantomjs"):
        ...
        dcap = dict(selenium.webdriver.DesiredCapabilities.PHANTOMJS)
        self.driver = selenium.webdriver.PhantomJS(
            "/Users/adair/Desktop/adair/apps/phantomjs-2.1.1-macosx/bin/phantomjs",
...
if __name__ == '__main__':
    s = Spider()
    s.store_path="comic/SailsKing"
    s.get_pages(["http://ac.qq.com/ComicView/index/id/505430/cid/{}".format(x) for x in range(860, 928)])
